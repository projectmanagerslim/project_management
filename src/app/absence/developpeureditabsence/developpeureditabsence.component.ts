...
@Component({
  selector: 'app-developpeureditabsence',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, ReactiveFormsModule],
  templateUrl: './developpeureditabsence.component.html',
  styleUrl: './developpeureditabsence.component.css'
})
export class DeveloppeureditabsenceComponent {
