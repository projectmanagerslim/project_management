...
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, ReactiveFormsModule],
  templateUrl: './admincreateaffectationgroupe.component.html' ,
  styleUrl: './admincreateaffectationgroupe.component.css'
  
})
export class AdmincreateaffectiongroupeComponent {
