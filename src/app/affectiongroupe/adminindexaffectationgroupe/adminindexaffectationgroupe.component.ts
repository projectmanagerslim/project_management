...
@Component({
  selector: 'app-adminindexaffectationgroupe',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, RouterModule],
  templateUrl: './adminindexaffectationgroupe.component.html',
  styleUrl: './adminindexaffectationgroupe.component.css'
})
export class AdminindexaffectationgroupeComponent {
