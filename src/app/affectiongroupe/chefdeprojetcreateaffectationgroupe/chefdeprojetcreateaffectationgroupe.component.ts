...
@Component({
  selector: 'app-admincreateaffectiongroupe',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, ReactiveFormsModule],
  templateUrl: './chefdeprojetcreateaffectationgroupe.component.html',
  styleUrl: './chefdeprojetcreateaffectationgroupe.component.css'
})
export class ChefdeprojetcreateaffectiongroupeComponent {
