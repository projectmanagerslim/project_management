...
@Component({
  selector: 'app-chefdeprojeteditaffectation',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, ReactiveFormsModule],
  templateUrl: './chefdeprojeteditaffectationgroupe.component.html',
  styleUrl: './chefdeprojeteditaffectationgroupe.component.css'
})
export class ChefdeprojeteditaffectationComponent {
