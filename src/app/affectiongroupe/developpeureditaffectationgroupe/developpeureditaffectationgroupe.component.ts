...
@Component({
  selector: 'app-developpeureditaffectation',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, ReactiveFormsModule],
  templateUrl: './developpeureditaffectationgroupe.component.html',
  styleUrl: './developpeureditaffectationgroupe.component.css'
})
export class DeveloppeureditaffectationComponent {
