...
@Component({
  selector: 'app-developpeurindexaffectationgroupe',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, RouterModule],
  templateUrl: './developpeurindexaffectationgroupe.component.html',
  styleUrl: './developpeurindexaffectationgroupe.component.css'
})
export class DeveloppeurindexaffectationgroupeComponent {
