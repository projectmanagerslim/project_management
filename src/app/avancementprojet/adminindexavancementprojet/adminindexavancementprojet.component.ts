...
@Component({
  selector: 'app-adminindexavancementprojet',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, RouterModule],
  templateUrl: './adminindexavancementprojet.component.html',
  styleUrl: './adminindexavancementprojet.component.css'
})
export class AdminindexavancementprojetComponent {
