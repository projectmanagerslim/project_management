...
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,],
  templateUrl: './Chefdeprojetviewavancementtache.component.html',
  styleUrl: './Chefdeprojetviewavancementtache.component.css'
})
export class ChefdeprojetviewavancementtacheComponent {
