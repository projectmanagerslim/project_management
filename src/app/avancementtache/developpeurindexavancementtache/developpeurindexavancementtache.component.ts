...
@Component({
  selector: 'app-developpeurindexavancementtache',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, RouterModule],
  templateUrl: './developpeurindexavancementtache.component.html',
  styleUrl: './developpeurindexavancementtache.component.css'
})
export class DeveloppeurindexavancementtacheComponent {
