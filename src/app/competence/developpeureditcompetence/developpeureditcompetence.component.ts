...
@Component({
  selector: 'app-developpeureditCompetence',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, ReactiveFormsModule],
  templateUrl: './developpeureditCompetence.component.html',
  styleUrl: './developpeureditCompetence.component.css'
})
export class DeveloppeureditCompetenceComponent {
