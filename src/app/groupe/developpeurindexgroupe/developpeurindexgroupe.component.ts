...
@Component({
  selector: 'app-developpeurindexgroupe',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, RouterModule],
  templateUrl: './developpeurindexgroupe.component.html',
  styleUrl: './developpeurindexgroupe.component.css'
})
export class DeveloppeurindexgroupeComponent {
