...
@Component({
  selector: 'app-chefdeprojetindexmessage',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, RouterModule],
  templateUrl: './chefdeprojetindexmessage.component.html',
  styleUrl: './chefdeprojetindexmessage.component.css'
})
export class ChefdeprojetindexmessageComponent {
