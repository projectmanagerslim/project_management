...
@Component({
  selector: 'app-developpeurindexnotification',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, RouterModule],
  templateUrl: './developpeurindexnotification.component.html',
  styleUrl: './developpeurindexnotification.component.css'
})
export class DeveloppeurindexnotificationComponent {
