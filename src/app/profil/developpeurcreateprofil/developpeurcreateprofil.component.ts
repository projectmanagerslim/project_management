...
@Component({
  selector: 'app-developpeurcreateprofil',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, ReactiveFormsModule],
  templateUrl: './developpeurcreateprofil.component.html',
  styleUrl: './developpeurcreateprofil.component.css'
})
export class DeveloppeurcreateprofilComponent {
