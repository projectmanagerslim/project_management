...
@Component({
  selector: 'app-developpeureditprofil',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, ReactiveFormsModule],
  templateUrl: './Developpeureditprofil.component.html',
  styleUrl: './Developpeureditprofil.component.css'
})
export class DeveloppeureditprofilComponent {
