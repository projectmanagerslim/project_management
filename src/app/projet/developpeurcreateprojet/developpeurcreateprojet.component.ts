...
@Component({
  selector: 'app-developpeurcreateprojet',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, ReactiveFormsModule],
  templateUrl: './developpeurcreateprojet.component.html',
  styleUrl: './developpeurcreateprojet.component.css'
})
export class DeveloppeurcreateprojetComponent {
