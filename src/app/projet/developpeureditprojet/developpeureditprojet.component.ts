...
@Component({
  selector: 'app-developpeureditprojet',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, ReactiveFormsModule],
  templateUrl: './developpeureditprojet.component.html',
  styleUrl: './developpeureditprojet.component.css'
})
export class DeveloppeurprojetComponent {
