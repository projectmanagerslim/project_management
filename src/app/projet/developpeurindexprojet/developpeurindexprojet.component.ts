...
@Component({
  selector: 'app-developpeurindexprojet',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, RouterModule],
  templateUrl: './developpeurindexprojet.component.html',
  styleUrl: './developpeurindexprojet.component.css'
})
export class DeveloppeurindexprojetComponent {
