...
@Component({
  selector: 'app-developpeuredittache',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, ReactiveFormsModule],
  templateUrl: './developpeuredittache.component.html',
  styleUrl: './developpeuredittache.component.css'
})
export class DeveloppeuredittacheComponent {
