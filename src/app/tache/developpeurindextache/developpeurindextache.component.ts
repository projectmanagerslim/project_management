...
@Component({
  selector: 'app-developpeurindextache',
standalone: true,
imports: [AdminheaderComponent,AdminmenuComponent,AdminfooterComponent,CommonModule, RouterModule],
  templateUrl: './developpeurindextache.component.html',
  styleUrl: './developpeurindextache.component.css'
})
export class DeveloppeurindextacheComponent {
